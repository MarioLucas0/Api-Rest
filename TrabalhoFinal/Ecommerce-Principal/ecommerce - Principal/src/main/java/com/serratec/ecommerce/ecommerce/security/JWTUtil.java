 ...
 * 
 * //Classe anotada como Componente. A partir dessa anotacao o Spring gerenciara
 * a instancia desse Bean
 ...
 * 
 * // Le a propriedade jwt-company-project-name a partir do
 * application.properties
 * 
 * @Value("${jwt-company-project-name}")
 * private String companyProjectName;
 * 
 * // Metodo utilizado no login e para criar o JWT contendo alguns dados gerais
 * e o
 * // e-mail do usuario
 ...
 * public String generateTokenWithUserData(User user) throws
 ...
 * 
 * // Pegando o email dentro da chave usuario (string json que contem os dados
 * do
 * // usuario)
 * User user = new User();
 * try {
 ...
 * } catch (JsonProcessingException e) {
 * throw new
 * Exception("Ocorreu um erro e nao foi possivel converter o usario a partir da string json - "
 * + e);
 * }
 * 
