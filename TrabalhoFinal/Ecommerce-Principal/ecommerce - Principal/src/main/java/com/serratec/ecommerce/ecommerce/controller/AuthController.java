 ...
 * 
 * import com.serratec.ecommerce.ecommerce.dto.CredenciaisLoginDTO;
 * import com.serratec.ecommerce.ecommerce.model.User;
 * import com.serratec.ecommerce.ecommerce.security.JWTUtil;
 * import com.serratec.ecommerce.ecommerce.service.UserService;
 * 
 * @RestController
 * 
 * @RequestMapping("/auth")
 ...
 * 
 * @PostMapping("/login")
 * public Map<String, Object> loginHandler(@RequestBody CredenciaisLoginDTO
 * credenciaisLoginDTO) {
 * try {
